class DistrictData {
  static final Map<String, List<String>> _districtList = {
    '1': [
      'Bhojpur',
      'Dhankuta',
      'Ilam',
  ...
  static final Map<String, List<String>> _localLevelList = {
    'Taplejung': [
      'Sidingba Ru. Mun.',
      'Meringden Ru. Mun.',
      'Maiwakhola Ru. Mun.',
  ...
  static Map<String, List<String>> get districtList => _districtList;
  static Map<String, List<String>> get localLevelList => _localLevelList;
}
